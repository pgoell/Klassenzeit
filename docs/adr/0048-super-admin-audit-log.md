...
No read API ships in v1. psql is the v1 reader. UI / API is filed as follow-up 10g.1.
...
- Audit-row read access is psql-only in v1; a UI is filed as follow-up 10g.1.
...
- OPEN_THINGS items 10g (closed by this ADR) and 10g.1 (follow-up).
