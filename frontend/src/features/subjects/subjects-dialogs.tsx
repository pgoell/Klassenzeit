      ...
      <DialogContent>
        ...
        <Form {...form}>
          <form className="space-y-4" onSubmit={form.handleSubmit(handleSubjectSubmit)}>
            ...
            <FormField
              control={form.control}
              name="prefer_late_period"
              render={({ field }) => (
                <FormItem>
                  <FormLabel>{t("subjects.fields.preferLatePeriod.label")}</FormLabel>
                  <FormControl>
                    <Input
                      type="number"
                      inputMode="numeric"
                  ...
                  <FormDescription>{t("subjects.fields.preferLatePeriod.help")}</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
